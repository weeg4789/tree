...
<html>
    ...
    <body>
        <div class="container">
            <h2>กรอกข้อมูลผู้ดูแลระบบ</h2>
            <br>
            <form action="user_amdin_insert.php" method="POST" enctype="multipart/form-data" class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">                                                                     
                        <label class="radio-inline">
                            <input type="radio" name="user_status" value="admin" checked>
                            Admin
                        </label>                       
                    </div>
                </div>
