                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <label class="radio-inline">
                            <input type="radio" name="user_prefix" value="นาย" required  <?php if($row['user_prefix']=="นาย") echo "checked"; ?>>
                            นาย
                        </label>
                        <label class="radio-inline">
                            <input type="radio" name="user_prefix" value="นาง" required <?php if($row['user_prefix']=="นาง") echo "checked"; ?>>
                            นาง
                        </label>
                        <label class="radio-inline">
                            <input type="radio" name="user_prefix" value="นางสาว" required <?php if($row['user_prefix']=="นางสาว") echo "checked"; ?>>
                            นางสาว
                        </label>
                    </div>
                </div>
