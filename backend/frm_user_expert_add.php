...
<html>
    ...
    <body>
        <div class="container">
            <h2>กรอกข้อมูลผู้เชี่ยวชาญ</h2>
            <br>
            <form action="user_expert_insert.php" method="POST" enctype="multipart/form-data" class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <label class="checkbox-inline">
                            <input type="radio" name="user_prefix" value="นาย" required>
                            นาย
                        </label>
                        <label class="checkbox-inline">
                            <input type="radio" name="user_prefix" value="นาง" required>
                            นาง
                        </label>
                        <label class="checkbox-inline">
                            <input type="radio" name="user_prefix" value="นางสาว" required>
                            นางสาว
                        </label>
                        <label class="checkbox-inline">
                            <input type="radio" name="user_prefix" value="ศาสตราจารย์" required>
                            ศาสตราจารย์ 
                        </label>
                        <label class="checkbox-inline">
                            <input type="radio" name="user_prefix" value="รองศาสตราจารย์" required>
                            รองศาสตราจารย์
                        </label>
                        <label class="checkbox-inline">
                            <input type="radio" name="user_prefix" value="ผู้ช่วยศาสตราจารย์" required>
                            ผู้ช่วยศาสตราจารย์
                        </label>
                        <label class="checkbox-inline">
                            <input type="radio" name="user_prefix" value="ดร." required>
                            ดร.
                        </label>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <input name="user_edu" type="text" class="form-control" placeholder="ปร.ด. เทคโนโลยีสารสนเทศ.... " required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <input name="user_expert" type="text" class="form-control" placeholder="เทคโนโลยีสารสนเทศ...." required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <input name="user_workplace" type="text" class="form-control" placeholder="มหาวิทยาลัย....." required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">                                              
                        <label class="radio-inline">
                            <input type="radio" name="user_status" value="expert" checked>
                            Expert
                        </label>                                              
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-md-offset-2 col-md-10">
                        ...
                        <a href="user_expert_manage.php" class="btn btn-danger">กลับหน้าหลัก</a>
                    </div>
                </div>
                <br><br>
