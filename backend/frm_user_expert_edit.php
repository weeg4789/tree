        ...
        <div class="container">
            ...
            <form action="user_expert_edit.php" method="POST" enctype="multipart/form-data" class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <input name="user_edu" type="text" class="form-control" value="<?php echo $row['user_edu']; ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <input name="user_expert" type="text" class="form-control" value="<?php echo $row['user_expert']; ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <input name="user_workplace" type="text" class="form-control" value="<?php echo $row['user_workplace']; ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">                                              
                        <label class="radio-inline">
                            <input type="radio" name="user_status" value="expert" <?php if($row['user_status']=='expert') echo "checked"; ?>>
                            Expert
                        </label>                                                
                        <label class="radio-inline">
                            <input type="radio" name="user_status" value="user" <?php if($row['user_status']=='user') echo "checked"; ?>>
                            User
                        </label>                        
                        <label class="radio-inline">
                            <input type="radio" name="user_status" value="admin" <?php if($row['user_status']=='admin') echo "checked"; ?>>
                            Admin
                        </label>                                                   
                    </div>
                </div>
