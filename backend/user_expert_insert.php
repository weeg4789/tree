<?php
        ...
        //คำสั่ง sql
        $query = "  INSERT INTO herb_user(user_prefix, user_name, user_surname, user_edu, user_expert, user_workplace, 
                    user_address, user_tel, user_username, user_password, user_email, user_status) 
                    VALUES ('$user_prefix' ,'$user_name','$user_surname', '$user_edu', '$user_expert', '$user_workplace', 
                            '$user_address', '$user_tel','$user_username', '$hash_login_password', '$user_email', '$user_status')";
