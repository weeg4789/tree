            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <a href="frm_user_expert_add.php" class="btn btn-primary" >
                        <span class="glyphicon glyphicon-plus"> เพิ่มผู้เชี่ยวชาญ</span>
                    </a>   
                ...
                <div class="col-md-6">
                    ...
                    <a href="user_admin_manage.php" type="button" class="btn btn-success">
                        <span class="glyphicon glyphicon-th-list"> รายชื่อผู้ดูแลระบบ </span>
                    </a>
                </div>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    <tr>
                        ...
                        <!-- ดูข้อมูล -->
                        <td><center><a href="show_user_expert_data.php?user_id=<?php echo base64_encode($row['user_id']); ?>" class="btn btn-info btn-md">
